...
import { ForestStoryComponentSimple } from '@/components/ForestStory'

export const Route = createFileRoute('/index-threejs-backup')({
  component: App,
})
...
function App() {
  ...
  return (
    <>
      ...
      {/* Epic Forest Story Hero */}
      <div className="relative h-screen">
        <ForestStoryComponentSimple className="w-full" />
        
        {/* Overlay with call-to-action */}
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-50">
          <button
            onClick={scrollToContent}
            className="px-8 py-4 bg-white/20 backdrop-blur-md border border-white/30 rounded-full text-white font-semibold hover:bg-white/30 transition-all duration-300 shadow-xl"
          >
            ✨ Descubre mi historia profesional
          </button>
        </div>
      </div>
      
      {/* Main Content */}
      <div id="main-content" className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
        <div className="flex">
